...
## 
## Makefile     : ACC.mk
## Generated on : Sun May 03 21:31:56 2026
...
%.obj : $(START_DIR)/ACC_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/ACC_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/ACC_grt_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/ACC_grt_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/ACC_grt_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
