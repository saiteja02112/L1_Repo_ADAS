...
## 
## Makefile     : ACC.mk
## Generated on : Sat Jul 11 12:50:27 2026
...
START_DIR                 = C:/Users/spadhi/Documents/Sai_Personal_Projects/L1_Repo/ACC_Model
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
DEFINES_STANDARD = -DMODEL=ACC -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/ACC_ert_rtw/ACC.c
...
%.obj : $(START_DIR)/ACC_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/ACC_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/ACC_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/ACC_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/ACC_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ACC.obj : $(START_DIR)/ACC_ert_rtw/ACC.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.obj : $(START_DIR)/ACC_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
